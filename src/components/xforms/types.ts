...
export interface FormSection {
    ...
    columns: NumberValue;           // Number of layout columns. Default = 1 (maxValue = 4 )
}
...
export interface FormField {
    ...
    validation?:     StringValue;     // The rule(s) to validate the field. Example: "required|min:5,max:90|..."
    errorMessage?:   StringValue;     // The error message displayed when the field validation fails
    ...
    size?:           StringValue;     // The field width. Default = '100%'
}
