<template>
    <div style="width: 70%; height: 60%; padding-top: 16px; margin: 0 auto; ">
...
import SvgEditorController, { controllerBindings } from './components/svg-editor/SvgEditorController';
...
let controller = controllerBindings(new SvgEditorController(points));
